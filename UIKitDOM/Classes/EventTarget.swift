@objc public protocol EventTarget {
  ...
  */
  func addEventListener(_ type: NSString, _ callback: ((_ event: EventProtocol) -> Void)?, _ options: AddEventListenerOptions?) -> NSNumber
  ...
  */
  func removeEventListenerById(_ type: NSString, _ id: NSNumber)
}
